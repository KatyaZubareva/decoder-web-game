        ...
        <div className="min-h-screen bg-gray-100 font-montserrat flex justify-center items-start py-10">
            <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-2xl">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    />
                    <p className="mt-4 text-xl font-semibold text-gray-700">{ user.email }</p>
                </div>
                ...
                <div className="mt-8 flex flex-col gap-4">
                    <Button variant="primary" className="bg-gray-900 hover:bg-gray-700 text-white font-semibold rounded-lg shadow-lg py-2">
                        Редактировать профиль
                    </Button>
                    <Button variant="primary" className="bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg shadow-lg py-2">
                        Выйти
                    </Button>
                </div>
            </div>
